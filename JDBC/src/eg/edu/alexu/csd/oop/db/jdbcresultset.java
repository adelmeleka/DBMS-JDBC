...
static int index =0;
    ...
    public void close() throws SQLException {
        d.workingDirectory=null; 
    }

    @Override
    public String getString(int i) throws SQLException {
        if(i-1<d.result[index].length){
        String result = (String) d.result[index][i-1];
        return result;
        }
       return null;
    }
    ...
    public String getString(String columnLabel) throws SQLException {
        ...
        int i;
        int found=-1;
        for(i=0;i<d.col.length;i++){
            if(columnLabel == d.col[i])
                found = i;
        }
        if(found>0){
         result = (String) d.result[index][found];   
        }
        return result;    
    }
    ...
    public ResultSetMetaData getMetaData() throws SQLException {
        return new jdbcsetmetadata();
    }

    @Override
    public Object getObject(int columnIndex) throws SQLException {
        Object result = d.result[index][columnIndex];  
        return result;
    }
